export class Game {
  public players: string[] = ['OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO','OOOOOOOOOOOO'];
